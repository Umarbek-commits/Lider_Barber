...
/// Client's bookings — upcoming (cancel), history (repeat / rate).
class MyBookingsPage extends ConsumerWidget {
  ...
  Future<void> _cancel(BuildContext context, WidgetRef ref, T t, Booking b) async {
    final withinHour = _startOf(b).isBefore(DateTime.now().add(const Duration(hours: 1)));
...
/// Cancel confirmation: penalty warning + destructive button disabled 3s.
